...
router.include_router(tmdb_lab_router, prefix="/tmdb-lab", tags=["TMDB 实验室"])
router.include_router(bangumi_lab_router, prefix="/bangumi_lab", tags=["Bangumi 实验室"])
router.include_router(actor_lab_router, prefix="/actor-lab", tags=["演员实验室"])
...
router.include_router(ai_lab_router, prefix="/ai", tags=["AI 实验室"])
