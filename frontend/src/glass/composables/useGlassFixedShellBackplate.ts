...
import type { ThemeCustomizerGlassAppearance, ThemeCustomizerGlassQuality } from '../host/useThemeCustomizer'
import type { LoginBackgroundLayer } from '../host/loginPresentation'
...
export function shouldUseGlassFixedShellBackplate(options: GlassFixedShellBackplateEligibility) {
  return (
    ...
    // MP 前端检查 themeName === 'glass'，AM 的 ACG 主题同时设置 data-theme='glass'
    (options.themeName === 'glass' || options.themeName === 'acg') &&
