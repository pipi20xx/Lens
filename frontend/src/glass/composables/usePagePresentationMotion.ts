...
function start(nextRouteKey: string, layoutRoot?: HTMLElement | null) {
  // MP 前端检查 data-theme='glass'，AM 的 ACG 主题同时设置 data-theme='glass' 和 class glass-theme-acg
  if (document.documentElement.dataset.theme !== 'glass' && !document.documentElement.classList.contains('glass-theme-acg')) {
    cancel()
    return false
  }
